...
$sql = "SELECT * FROM product_catlog";
...
<body>
    ...
    <div class="card">
        <div class="card-header">Catelog  Table</div>
        <div class="card-body">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='delete.php?pcid=".$row['pcid']."' onclick='return confirm(\"Are you sure you want to delete this?\");'>Delete</a></td>";

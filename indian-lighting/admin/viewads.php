...
<body>
    ...
    <div class="card">
        <div class="card-header">Product Categories Table</div>
        <div class="card-body">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><img src=".$row['img']." width='100'></td>";
                 echo "<td><a href='delete.php?aid=".$row['aid']."' onclick='return confirm(\"Are you sure you want to delete this?\");'>Delete</a></td>";
                echo "</tr>";
            }
        } else {

...
$username = "ila_admin";      // your DB usernamea
...
$sql = "SELECT id, `product_categories_id`, product_name, product_description, `product_img`, price, stock_quantity, is_active FROM product_detail_owner;";
// echo $sql; 
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . htmlspecialchars($row['product_categories_id']) . "</td>";
                echo "<td>" . htmlspecialchars($row['product_name']) . "</td>";
                echo "<td>" . htmlspecialchars($row['product_description']) . "</td>";
                echo "<td><img src='" . htmlspecialchars($row['product_img']) . "' width='60'></td>";

...
if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
    ...
    $sql = "INSERT INTO `product_detail_owner`( `product_categories_id`, `product_name`, `product_description`,`price`, `product_img`,`stock_quantity`,`is_active`) VALUES ('$category_id','$product_name', '$product_description','$price', '$target_file', '$stock_quantity', '$is_active')";
// echo $sql;
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
    <div class="card">
        <div class="card-header">Add Own Products</div>
        <div class="card-body">

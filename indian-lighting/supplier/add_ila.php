...
if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
    ...
    $sql = "INSERT INTO `stock_exchange_products`(`id`, `product_name`, `category`, `description`, `available_quantity`, `min_order_quantity`, `price_per_unit`, `location`, `company_name`, `image`) VALUES (null,'$product_name','$category_id', '$product_description','$stock_quantity','$min_quantity', '$price','no','$supplier_id','$target_file')";
// echo $sql;
...
$result=$conn->query($sql) ;
   while($row=$result->fetch_assoc()){
                ...
                <div class="mb-3 row">
                  ...
                  <!-- Stock Quantity -->
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Min Quantity</label>
                    <div class="col-sm-10">

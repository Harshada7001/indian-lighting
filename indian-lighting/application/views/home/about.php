 <section class="main-header main-header-blog" style="background-image:url(<?= base_url('static/frontend/'); ?>assets/images/gallery-1.jpg)">
            <header>
        ...
        <section class="our-team">
            <div class="container">
                ...
                <!--        <h1 style="color: #fff;" class="h2 title">Meet our team</h1>-->
                <!--        <div class="text">-->
                <!--            <p style="color: #fff;">Our architects and designers constantly and carefully monitor the environment, they accept and develop changes, research fashion and architectural, as well as sociological, changes and transform them into unique design.</p>-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <!--                    <div class="inner">-->
                <!--                        <h3 class="title">Prerna Pawar</h3>-->
                <!--                        <h6 class="title">Director</h6>-->
                <!--                    </div>-->
                <!--                </div>-->
                <!--                <div class="image">-->
                <!--                    <img src="<?= base_url('static/frontend/'); ?>assets/images/user-1.jpg" alt="" height="300px" />-->
                <!--                </div>-->
                ...
                <!--                <div class="details details-text">-->
                <!--                    <div class="inner">-->
                <!--                        <h3 class="title">Divya Sonar</h3>-->
                <!--                        <h6 class="title">Architect</h6>-->
                <!--                    </div>-->
                <!--                </div>-->
                <!--                <div class="image">-->
                <!--                    <img src="<?= base_url('static/frontend/'); ?>assets/images/user-2.jpg" alt="" height="300px" />-->
                <!--                </div>-->
                <!--                <div class="details details-social">-->
                <!--                    <div class="inner">-->
                ...
                <!--                <div class="details details-text">-->
                <!--                    <div class="inner">-->
                <!--                        <h3 class="title">Roshani Gokulnath</h3>-->
                ...
                <!--                <div class="details details-text">-->
                <!--                    <div class="inner">-->
                <!--                        <h3 class="title">Meera Deshmukh</h3>-->
                <!--                        <h6 class="title">Supervisor</h6>-->
                <!--                    </div>-->
                <!--                </div>-->
                <!--                <div class="image">-->
                <!--                    <img src="<?= base_url('static/frontend/'); ?>assets/images/user-4.jpg" alt="" height="280px" />-->
                <!--                </div>-->
                <!--                <div class="details details-social">-->
                <!--                    <div class="inner">-->
                <!--                        <a href="#"><i class="fa fa-facebook"></i></a>-->
        ...
        <!--<section class="cards">-->
            ...
            <!-- <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <figure>
                            <figcaption style="background-image:url(assets/images/blog-7.jpg)">
                                <img src="<?//= base_url('static/frontend/'); ?>assets/images/blog-1.jpg" alt="" />
                            </figcaption>
...
->
                    ...
                    <div class="col-md-4">
                        <figure>
                            <figcaption style="background-image:url(assets/images/blog-2.jpg)">
                                <img src="<?//= base_url('static/frontend/'); ?>assets/images/blog-2.jpg" alt="" />
                            </figcaption>
                    ...
                    <div class="col-md-4">
                        <figure>
                            <figcaption style="background-image:url(assets/images/blog-3.jpg)">
                                <img src="<?//= base_url('static/frontend/'); ?>assets/images/blog-3.jpg" alt="" />
                            </figcaption>
                    ...
                    <div class="col-md-4">
                        <figure>
                            <figcaption style="background-image:url(assets/images/blog-4.jpg)">
                                <img src="<?//= base_url('static/frontend/'); ?>assets/images/blog-4.jpg" alt="" />
                            </figcaption>
                    ...
                    <div class="col-md-4">
                        <figure>
                            <figcaption style="background-image:url(assets/images/blog-5.jpg)">
                                <img src="<?//= base_url('static/frontend/'); ?>assets/images/blog-5.jpg" alt="" />
                            </figcaption>
        ...
        <!-- ========================  History ======================== -->
           ...
           <!--  <section class="history">
            <div class="container">
              ...
              <div class="row row-block">
                    <div class="col-md-5 history-image" style="background-image:url(assets/images/blog-4.jpg)">
           ...
           <div class="row row-block">
                    <div class="col-md-5 history-image" style="background-image:url(assets/images/blog-5.jpg)">
                        <div class="history-title">
          ...
          <div class="row row-block">
                    <div class="col-md-5 history-image" style="background-image:url(assets/images/blog-6.jpg)">
                        <div class="history-title">
        ...
        <section class="banner" style="background-image:url(<?= base_url('static/frontend/'); ?>assets/images/gallery-2.jpg)">
            <div class="container">
                <div class="row">
        ...
        <section class="blog blog-block">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <article>
                            <a href="article.html">
                                <div class="image">
                                    <img src="<?= base_url('static/frontend/'); ?>assets/images/project-1.jpg" alt="" />
                                </div>
                                <div class="entry entry-block">
                                    <div class="date">10 Jan 2017</div>
                                    <div class="title">
                    ...
                    <div class="col-sm-4">
                        <article>
                            <a href="article.html">
                                <div class="image">
                                    <img src="<?= base_url('static/frontend/'); ?>assets/images/project-2.jpg" alt="" />
                                </div>
                                <div class="entry entry-block">
                    ...
                    <div class="col-sm-4">
                        <article>
                            <a href="article.html">
                                <div class="image">
                                    <img src="<?= base_url('static/frontend/'); ?>assets/images/project-3.jpg" alt="" />
                                </div>
                                <div class="entry entry-block">
                ...
                <!--button more-->
                <!--<div class="wrapper-more">-->
                <!--    <a href="category.html" class="btn btn-main">View all posts</a>-->
                <!--</div>-->
        ...
        <!--                <div class="quote">-->
        <!--                    <div class="image">-->
        <!--                        <img src="<?= base_url('static/frontend/'); ?>assets/images/user-3.jpg" alt="" />-->
        <!--                    </div>-->
        <!--                    <div class="text">-->
        <!--                        <h4>Jenna Hale</h4>-->
        ...
        <!--                <div class="quote">-->
        <!--                    <div class="image">-->
        <!--                        <img src="<?= base_url('static/frontend/'); ?>assets/images/user-1.jpg" alt="" />-->
        <!--                    </div>-->
        <!--                    <div class="text">-->
        <!--                        <h4>Glen Jordan</h4>-->
        <!--                        <p>Ipsum dolore eros dolore <br />dolor dolores sit iriure</p>-->
        ...
        <!--                <div class="quote">-->
        <!--                    <div class="image">-->
        <!--                        <img src="<?= base_url('static/frontend/'); ?>assets/images/user-4.jpg" alt="" />-->
        <!--                    </div>-->
        <!--                    <div class="text">-->
        <!--                        <h4>Lea Nils</h4>-->
        <!--                        <p>Ipsum dolore eros dolore <br />dolor dolores sit iriure</p>-->
        ...
        <!--                <div class="quote">-->
        <!--                    <div class="image">-->
        <!--                        <img src="<?= base_url('static/frontend/'); ?>assets/images/user-5.jpg" alt="" />-->
        <!--                    </div>-->
        <!--                    <div class="text">-->
        <!--                        <h4>Nora Star</h4>-->
        <!--                        <p>Ipsum dolore eros dolore <br />dolor dolores sit iriure</p>-->

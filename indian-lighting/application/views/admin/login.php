...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?= base_url('static/backend');?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
                                   <img class="logo" src="<?= base_url('uploads/'); ?>logodfurnusa.png" style="width: 40vh"alt=""></br>
...
<!-- AdminLTE App -->
<script src="<?= base_url('static/backend');?>/dist/js/adminlte.min.js"></script>
</body>
</html>

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('project/addtest'); ?>">Add Testimonials</a></li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <!--<a href="<?//= base_url('Customersays/edit_customersays/'.$value->id); ?>">Edit</a> |-->
				  <a href="<?= base_url('project/delete_test/'.$value->id); ?>">Delete</a>
				</td>
                  </tr>
				  <?php  $i++; } ?>
                  </tbody>
